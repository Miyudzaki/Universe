...
function AutoUpdate(data)
    if tonumber(data) > tonumber(version) then
        ...
        DownloadFileAsync("https://github.com/Miyudzaki/ChampionScripts/blob/master/NasusKit.lua", SCRIPT_PATH .. "NasusKit.lua", function() print("Update Complete, please 2x F6!") return end)
    end
end

GetWebResultAsync("https://github.com/Miyudzaki/ChampionScripts/blob/master/NasusKit.version", AutoUpdate)
